...
const baseURL = `${environment.apiUrl}/MasterValue`;
...
export class MasterValueService {
  ...
  addByApplicant(data: any): Observable<any> {
    return this.httpClient.post(`${baseURL}/AddByApplicant`, data);
  }
  ...
  approveNewMVRequest(data: any): Observable<any> {
    return this.httpClient.post(`${baseURL}/ApproveNewMVRequest`, data);
  }

  rejectNewMVRequest(data: any): Observable<any> {
    return this.httpClient.post(`${baseURL}/RejectNewMVRequest`, data);
  }

  restoreMasterValue(data: any): Observable<any> {
    return this.httpClient.post(`${baseURL}/RestoreMasterValue`, data);
  }
}
